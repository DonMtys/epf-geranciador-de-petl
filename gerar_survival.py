...
@media (max-width: 520px) {
  ...
  .sub { font-size: .8rem; margin-bottom: 12px; }
  .controls { gap: 5px; }
  .controls label { flex: 1 1 46%; justify-content: center; padding: 8px 6px; font-size: .74rem; text-align: center; }
  .hud { gap: 8px; }
  .vidas { font-size: 1.1rem; letter-spacing: 1px; white-space: nowrap; }
  .record-txt, #num-badge { font-size: .72rem; }
  .card { padding: 16px; border-radius: 10px; }
  .question { font-size: .98rem; line-height: 1.45; }
  .opts { grid-template-columns: 1fr; gap: 8px; margin-top: 14px; }
  .opt { min-height: 48px; padding: 12px 10px; font-size: .95rem; }
  #result { padding: 24px 12px; }
